...
/**
 * print_hex - function that prints an unsigned int in hexidecimal form
...
/**
 * print_x -f that takes an unsigned int and prints it in lowercase hex notation
...
/**
 * _pow - function that calculates an exponent
 * @base: base of an exponent
...
/**
 * print_p - function that prints an address
